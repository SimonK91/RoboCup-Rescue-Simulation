...
import team.communicationstrategies.agentcommunicationstrategies.PoliceForceCommunicationStrategy;
...
public class PoliceForceAgent extends AbstractAgent<PoliceForce> {
    ...
    protected void postConnect() {
        super.postConnect();
        communicationStrategy = new PoliceForceCommunicationStrategy(this);
    ...
    protected void think(int time, ChangeSet changed, Collection<Command> heard) {
        ...
        if (target != null) {
            String msg = CommunicationProtocol.CLEARING_BLOCKADE.Short() + " " + target;

...
import team.viewers.FirePredictPracticeViewer;
import team.viewers.FirePredictViewer;
import team.viewers.PathPlanningViewer;
import team.viewers.ObstacleDetectorViewer;
import team.viewers.SampleViewer;
...
public final class LaunchTeam {
    ...
    */
    ...
    private static void connect(ComponentLauncher launcher, int fb, int pf, int at, Config config) throws InterruptedException, ConnectionException {
        ...
        try {
        	launcher.connect(new FirePredictPracticeViewer(){});
        }
        catch (ComponentConnectionException e) {
            Logger.info("failed: " + e.getMessage());
        }

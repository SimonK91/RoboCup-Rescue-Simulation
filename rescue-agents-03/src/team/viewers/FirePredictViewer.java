...
import team.layers.FirePredictLayer;

/**
   A simple viewer.
 */
public class FirePredictViewer extends StandardViewer {
    ...
    private FirePredictLayer fpl;
    private FireStationCentre centre;
    public FirePredictViewer(FireStationCentre centre, Config config){
    	this.centre = centre;
...
//        scoreFunction = makeScoreFunction();
        ...
        fpl = new FirePredictLayer(centre);
        viewer.addLayer(fpl);

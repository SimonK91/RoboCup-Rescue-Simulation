...
import team.layers.FirePredictPracticeLayer;

/**
   A simple viewer.
 */
public class FirePredictPracticeViewer extends StandardViewer {
    ...
    private FirePredictPracticeLayer fpl;
	...
	public void postConnect() {
        ...
        fpl = new FirePredictPracticeLayer();
        viewer.addLayer(fpl);

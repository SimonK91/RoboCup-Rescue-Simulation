...
import team.layers.ObstacleLayer;
import team.layers.RoadNetworkLayer;
import team.pathplanners.LongRoad;

/**
   A simple viewer.
 */
public class PathPlanningViewer extends StandardViewer {
    ...
    protected void postConnect() {
        ...
        viewer.addLayer(new RoadNetworkLayer());
        ...
        viewer.addViewListener(new ViewListener() {
                ...
                public void objectsClicked(ViewComponent view, List<RenderedObject> objects) {
                    for (RenderedObject next : objects) {
                        ...
                        String str = next.getObject().toString().split(" ")[1];
                        LongRoad.debugClickCallback(str.substring(1, str.length()-1));
                    }
                }
